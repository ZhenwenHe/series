...
//import backup.classification.Classification;
...
//            MultiSeries testMultiSeries = SeriesBuilder.readTSV(testFilePath);
//
//            SaxDistanceMetric<Series> disFunc = new SaxDistanceMetric<>(10, 16);
//            //System.out.println(Classification.timeSeriesClassifier(trainMultiSeries, testMultiSeries, disFunc));
...
//            MultiSeries testMultiSeries = SeriesBuilder.readTSV(testFilePath);
//
//            ESaxDistanceMetric<Series> disFunc = new ESaxDistanceMetric<>(10, 16);
//            System.out.println(Classification.timeSeriesClassifier(trainMultiSeries, testMultiSeries, disFunc));
//            //logger.info(Classification.timeSeriesClassifier(trainMultiSeries, testMultiSeries, disFunc));
//        } catch (Exception e) {
//            e.printStackTrace();
...
//                    MultiSeries testMultiSeries = SeriesBuilder.readTSV(testPathList.get(k));
//
//                    SaxTGDistanceMetric<Series> disFunc = new SaxTGDistanceMetric<>(w, alphabet);
...
//                MultiSeries testMultiSeries = SeriesBuilder.readTSV(testPathList.get(k));
//
//                SaxDistanceMetric<Series> disFunc = new SaxDistanceMetric<>(w, alphabet);
//                SaxTDDistanceMetric<Series> disFunc1 = new SaxTDDistanceMetric<>(w, alphabet);
//                SaxTGDistanceMetric<Series> disFunc2 = new SaxTGDistanceMetric<>(w, alphabet);
//                ESaxDistanceMetric<Series> disFunc3 = new ESaxDistanceMetric<>(w, alphabet);
//                System.out.print(Classification.timeSeriesClassifier(trainMultiSeries, testMultiSeries, disFunc) + "        ");
...
//                MultiSeries testMultiSeries = SeriesBuilder.readTSV(testPathList.get(k));
//
//                SaxTGDistanceMetric<Series> disFunc = new SaxTGDistanceMetric<>(20, 16);
//                System.out.println(Classification.timeSeriesClassifier(trainMultiSeries, testMultiSeries, disFunc));
//            } catch (Exception e) {
//                e.printStackTrace();
//            }
...
//                    MultiSeries testMultiSeries = SeriesBuilder.readTSV(testPathList.get(k));
//
//                    ESaxDistanceMetric<Series> disFunc = new ESaxDistanceMetric<>(w, alphabet);
...
//                MultiSeries testMultiSeries = SeriesBuilder.readTSV(testPathList.get(k));
//
//                SaxDistanceMetric<Series> disFunc = new SaxDistanceMetric<>(10, 9);
