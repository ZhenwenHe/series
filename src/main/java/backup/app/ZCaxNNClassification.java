...
//import cn.edu.cug.cs.gtl.series.ml.distances.ZCaxDistanceMetric;
...
//
//public class ZCaxNNClassification {
//    private static final Logger LOGGER = LoggerFactory.getLogger(ZCaxNNClassification.class);
//
...
//        int k = 0;
//        config.setResultFileName("zcax_nn.xls");
//
...
//                    ZCaxDistanceMetric<Series> disFunc = new ZCaxDistanceMetric<>(i, tioPlane);
