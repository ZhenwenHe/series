...
public class HCaxDistanceMetric<T extends NumericalData> implements DistanceMetric<T> {
    protected int wordSize;
    protected TIOPlane tioPlane;

    public HCaxDistanceMetric(int wordSize, TIOPlane tioPlane) {
    ...
    public double distance(Object a, Object b) {
        if (a instanceof Series && b instanceof Series) {
            return cn.edu.cug.cs.gtl.series.common.hcax.Utils.distance((Series) a, (Series) b, this.wordSize, tioPlane);
        }
        else {
            Series sa,sb;
            ...
            return cn.edu.cug.cs.gtl.series.common.hax.Utils.distance((Series) sa, (Series) sb, this.wordSize, tioPlane);
