package cn.edu.cug.cs.gtl.series.storage;

import cn.edu.cug.cs.gtl.series.common.MultiSeries;
import cn.edu.cug.cs.gtl.series.common.Point;
...
public interface Writer {
     ...
     * @return
     */
    default boolean writeSeries(MultiSeries multiSeries){
        return writeSeries(multiSeries.toList());
    }
}
