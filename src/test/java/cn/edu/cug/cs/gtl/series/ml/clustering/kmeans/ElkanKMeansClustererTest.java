...
import cn.edu.cug.cs.gtl.series.ml.clustering.kmeans.ElkanKMeansClusterer;
...
public class ElkanKMeansClustererTest {
    String testFileName;
    ...
    public void predict() {
        try {
            ...
            ElkanKMeansClusterer nn = new ElkanKMeansClusterer(trainSet,disFunc);
