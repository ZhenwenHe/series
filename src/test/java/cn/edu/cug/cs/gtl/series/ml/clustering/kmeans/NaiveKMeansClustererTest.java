...
import cn.edu.cug.cs.gtl.series.ml.clustering.kmeans.NaiveKMeansClusterer;
...
public class NaiveKMeansClustererTest {
    String testFileName;
    ...
    public void predict() {
        try {
            ...
            NaiveKMeansClusterer nn = new NaiveKMeansClusterer(trainSet,disFunc);
